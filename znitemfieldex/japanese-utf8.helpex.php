...
<ol>
	<li>フィールドには、複数のタイプがあります。<br />
		フィールドを追加したら、<img src="<?php echo $plugin_dir; ?>edit.gif" title="編集" />（編集）から、フィールドの設定を行ってください。設定内容は以下の通りです。<br />
		（表2.）<br />
		<a name="ftype"></a>
...
<ol>
	<li>リレーションを設定しているフィールド（Selectタイプ）には、<img src="<?php echo $plugin_dir; ?>link.gif" align="top" />が付きます。<br />
		<ul>
		<li>一覧のタイトル部分の<img src="<?php echo $plugin_dir; ?>link.gif" align="top" />をクリックすると、リレーション先のフィールドの編集画面に飛びます。</li>
		<li>設定していたリレーション先が、変更・削除されてしまった場合、<img src="<?php echo $plugin_dir; ?>link_dele.gif" align="top" />が表示されます。</li>
		<li>レコードには、リレーション先のTextタイプフィールドのデータが表示されます。</li>
		<li>リレーション先にデータがないレコードには、<img src="<?php echo $plugin_dir; ?>link.gif" align="top" />のみが表示されます。</li>
		</ul>
		<br />
	</li>
